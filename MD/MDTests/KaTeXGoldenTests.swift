...
// formula. Re-baseline with KATEX_GOLDEN_UPDATE=1 after a deliberate change.
@MainActor
final class KaTeXGoldenTests: XCTestCase {

    // Chosen to reach every builder with its own layout rule at least once,
    // plus the shapes that arrive from real documents.
    ...
    // Metrics to four decimals plus a hash of the rendered pixels.
